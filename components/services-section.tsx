...
const services = [
  {
    ...
    description: "Limpeza, lubrificação, afinação, alinhamento e testes de funcionamento.",
    price: "8€",
  ...
  },
  {
    ...
    description: "Diagnóstico técnico, reparação e substituição de componentes quando necessário.",
    price: "Sob consulta",
  ...
  },
  {
    ...
    description: "Atendimento nacional, instruções de envio e devolução segura do equipamento.",
    price: "Nacional",
